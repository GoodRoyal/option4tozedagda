...
The subject matter disclosed in this provisional patent application has been formally verified using machine-checked proofs in **Cubical Agda** (version 2.6.4+).
